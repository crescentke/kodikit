                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">                                    
                                    ...
                                    foreach ($building as $building_row) {
                                        ...
                                        $property_id = urlencode(base64_encode($building_row->property_id));
                                        $building_name = $building_row->name;
                                        $number_of_houses = $building_row->number_of_houses;
                                    }
                                    ?>
                                    <?php if ($a_property > 0 || $e_property > 0 && $number_of_houses > count($houses)) { ?>
                                        <button type="button" data-toggle="modal" data-target="#houseModal" class="btn btn-primary pull-right"><i class="fa fa-plus"></i></button>
                                    <?php } ?>
                                    <h4 class="page-title">Buildings </h4>
                                    <ol class="breadcrumb">
                                        <li><a href="<?php echo base_url('home'); ?>">Home</a></li>
                                        <li><a href="<?php echo base_url('home/property'); ?>">Properties</a></li>
                                        <li><a href="<?php echo base_url('home/updateproperty/' . $property_id); ?>">Buildings</a></li>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="houseModalLabel"><i class="fa fa-edit"></i> Add House</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" action="<?php echo base_url('home/create_house'); ?>" id="addusergroup">
                                            <input type="hidden" name="bid" id="bid" value="<?php echo $building_id; ?>">
                                            <div class="form-group">
                                                <label for="hname">House Name</label>
                                                <input type="text" class="form-control" name="hname" id="hname" required="" placeholder="House name">
                                            </div>
                                            <div class="form-group">
                                                <label for="hrent">Rent</label>
                                                <input type="number" class="form-control" name="hrent" id="hrent" required="" placeholder="Rent">
                                            </div>
                                            <div class="form-group">
                                                <label for="hdeposit">Deposit</label>
                                                <input type="number" class="form-control" name="hdeposit" id="hdeposit" required="" placeholder="Deposit">
                                            </div>
                                            <div class="form-group">
                                                <label for="hdetails">Details</label>
                                                <textarea class="form-control" name="hdetails" id="hdetails" required="" placeholder="House details"></textarea>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default card-box table-responsive">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fa fa-home"></i> <?php echo $building_name; ?> </h3>
                                    </div>
                                        ...
                                        <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="datatable-buttons_wrapper">
                                            <?php if (count($houses) > 0) { ?>
                                                ...
                                                <table aria-describedby="datatable-buttons_info" role="grid" id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline">
                                                    <thead>
                                                        <tr role="row">
                                                            <th aria-label="House Name: activate to sort column descending" aria-sort="ascending" style="width: 140px;" colspan="1" rowspan="1" aria-controls="datatable-buttons" tabindex="0" class="sorting_asc">House Name</th>
                                                            <th aria-label="Rent: activate to sort column ascending" style="width: 236px;" colspan="1" rowspan="1" aria-controls="datatable-buttons" tabindex="0" class="sorting">Rent</th>
                                                            <th aria-label="Deposit: activate to sort column ascending" style="width: 236px;" colspan="1" rowspan="1" aria-controls="datatable-buttons" tabindex="0" class="sorting">Deposit</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($houses as $houses_row):
                                                            ...
                                                            $house_id_two = urlencode(base64_encode($house_id));
                                                            $building__id = $houses_row->building_id;
                                                            $house_name = $houses_row->name;
                                                            $house_rent = $houses_row->rent;
                                                            $house_deposit = $houses_row->deposit;
                                                            $house_details = $houses_row->details;
                                                            $house_status = $houses_row->house_status;
                                                            ?>
                                                            <tr class="odd" role="row">
                                                                <td tabindex="0" class="sorting_1"><?php echo $house_name; ?></td>
                                                                <td><?php echo $house_rent; ?></td>
                                                                <td><?php echo $house_deposit; ?></td>
                                                                <td>
                                                                    <a href="<?php echo '#' . $house_id; ?>"  data-toggle="modal" data-target="#<?php echo $house_id;?>Modal" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                                                    <div class="modal fade" id="<?php echo $house_id;?>Modal" tabindex="-1" role="dialog" aria-labelledby="<?php echo $house_id;?>ModalLabel">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h4 class="modal-title" id="houseModalLabel"><i class="fa fa-edit"></i> Add House</h4>
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <form method="post" action="<?php echo base_url('home/update_house'); ?>" id="">
                                                                                        <input type="hidden" name="hid" id="hid" value="<?php echo $house_id; ?>">
                                                                                        <input type="hidden" name="bid" id="bid" value="<?php echo $building__id; ?>">
                                                                                        <div class="form-group">
                                                                                            <label for="hname">House Name</label>
                                                                                            <input type="text" value="<?php echo $house_name; ?>" class="form-control" name="hname" id="hname" required="" placeholder="House name">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="hrent">Rent</label>
                                                                                            <input type="number" value="<?php echo $house_rent; ?>" class="form-control" name="hrent" id="hrent" required="" placeholder="Rent">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="hdeposit">Deposit</label>
                                                                                            <input type="number" value="<?php echo $house_deposit; ?>" class="form-control" name="hdeposit" id="hdeposit" required="" placeholder="Deposit">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="hdetails">Details</label>
                                                                                            <textarea class="form-control" value="<?php echo $house_details; ?>" name="hdetails" id="hdetails" required="" placeholder="House details"> <?php echo $house_details; ?></textarea>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="hstatus">Status</label>
                                                                                            <select name="hstatus" id="hstatus" class="form-control" required="">
                                            ...
                                            <?php } else { ?>
                                                <table class="table table-striped table-bordered">
                                                    <thead>
                                                        <tr role="row">
                                                            <th aria-label="House Name: activate to sort column descending" aria-sort="ascending" style="width: 140px;
                                                                " colspan="1" rowspan="1" aria-controls="datatable-buttons" tabindex="0" class="sorting_asc">House Name</th>
                                                            <th aria-label="Rent: activate to sort column ascending" style="width: 236px;
                                                                " colspan="1" rowspan="1" aria-controls="datatable-buttons" tabindex="0" class="sorting">Rent</th>
                                                            <th aria-label="Deposit: activate to sort column ascending" style="width: 236px;
                                                                " colspan="1" rowspan="1" aria-controls="datatable-buttons" tabindex="0" class="sorting">Deposit</th>
                                                            <th aria-label="Action: activate to sort column ascending" style="width: 73px;
                                                                " colspan="1" rowspan="1" aria-controls="datatable-buttons" tabindex="0" class="sorting">Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
