                        ...
                        <ul>
                            ...
                            <?php if ($a_property > 0 || $e_property > 0 || $v_property > 0) { ?>
                                <li class="has_sub">
                                    ...
                                    <ul class="list-unstyled">
                                        <li class="active"><a href="<?php echo base_url('home/category'); ?>">Categories</a></li>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <button type="button" data-toggle="modal" data-target="#userPropertyModal" class="btn btn-primary pull-right"><i class="fa fa-plus"></i></button>
                                    <h4 class="page-title">Property Groups </h4>
                                    <ol class="breadcrumb">
                                        <li><a href="<?php echo base_url('home'); ?>">Home</a></li>
                                        <li class="active">Property Groups</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- user Group Modal -->
                        <div class="modal fade" id="userPropertyModal" tabindex="-1" role="dialog" aria-labelledby="userPropertyModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="userPropertyModalLabel"><i class="fa fa-edit"></i> Add Property Group</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" action="<?php echo base_url('home/create_propertygroup'); ?>" id="addpropertygroup">
                                            <input type="hidden" name="uid" id="uid" value="<?php echo $user_id; ?>">
                                            <div class="form-group">
                                                <label for="pname">Property Group Name</label>
                                                <input type="text" class="form-control" name="pname" id="pname" required="" placeholder="Property group name">
                                            </div>
                                        ...
                                        <div class="dataTables_wrapper form-inline dt-bootstrap no-footer" id="datatable-buttons_wrapper">
                                            <?php if (count($property_groups) > 0) { ?>
                                                <table aria-describedby="datatable-buttons_info" role="grid" id="datatable-buttons" class="table table-striped table-bordered dataTable no-footer dtr-inline">
                                                    <thead>
                                                        <tr role="row">
                                                            <th aria-label="Property Group Name: activate to sort column descending" aria-sort="ascending" style="width: 140px;" colspan="1" rowspan="1" aria-controls="datatable-buttons" tabindex="0" class="sorting_asc">Property Group Name</th>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        foreach ($property_groups as $property_groups_row):
                                                            $property_group_id = $property_groups_row->property_group_id;
                                                            $property_group_name = $property_groups_row->name;
                                                            ?>
                                                            <tr class="odd" role="row">
                                                                <td tabindex="0" class="sorting_1"><?php echo $property_group_name; ?></td>
                                                                <td>
                                                                    <form id="" method="post" action="<?php echo base_url("home/droppropertygroup"); ?>">
                                                                        <input type="hidden" name="property_group_id" id="property_group_id" value="<?php echo $property_group_id; ?>">
